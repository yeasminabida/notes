...
// <button id="closeBtn" onclick="closePop()">close</button>
...
//     <i class="fa-soild fa-pen" </i>
//     </button>

//     <button id="deleteBtn" onclick="deleteNote (${note.id})">
//     <i class="fa-soild fa-trash" </i>
//     </button>
//     </div>
// `;
...
//     const notes =JSON.parse(localStorage.getItem ('notes')) || [];
//     const noteToEdit = notes.find(note => notes.id == noteId);
...
// const updateNote = note.map(note =>{
//     if(note.id == noteId){
